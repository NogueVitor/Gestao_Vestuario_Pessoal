...
/**
 * Classe que representa uma saia
 */
public class Saia extends Item implements IEmprestavel, ILavavel {
    private boolean emprestado;
    private String nomeEmprestado;
    private LocalDate dataEmprestimo;
    private List<LocalDate> datasLavagem;

    public Saia(String nome, String cor, String tamanho, String lojaOrigem, String conservacao, ImageIcon foto) {
